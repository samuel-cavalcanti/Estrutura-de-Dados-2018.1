...
${OBJECTDIR}/source_code/ListaCandidatos.o: source_code/ListaCandidatos.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_code/ListaCandidatos.o source_code/ListaCandidatos.cpp

${OBJECTDIR}/source_code/NoCandidato.o: source_code/NoCandidato.cpp
	${MKDIR} -p ${OBJECTDIR}/source_code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_code/NoCandidato.o source_code/NoCandidato.cpp

${OBJECTDIR}/source_code/TestPratica_1.o: source_code/TestPratica_1.cpp
	${MKDIR} -p ${OBJECTDIR}/source_code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_code/TestPratica_1.o source_code/TestPratica_1.cpp
